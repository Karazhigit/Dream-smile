...
export async function GET(request:Request){
  ...
  if(schedulesResult.error||exceptionsResult.error){console.error("[api/doctor/schedule GET] Query failed",{schedulesError:schedulesResult.error,exceptionsError:exceptionsResult.error});return Response.json({error:"Не удалось загрузить расписание."},{status:500})}
